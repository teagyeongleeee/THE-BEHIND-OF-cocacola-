...
let posM = [[-6,32, 200,] , [58, 60, 165] , [-5, 70, 230], [45.5, 20, 250]]; // x, y, scale-px
...
let posFocusM = [[15, 11, 290] , [15, 11, 290] , [15, 11, 290], [15, 11, 290]]; // x, y, scale-px

let textPosW = [[60, 35, 430] , [60, 34, 430] , [60, 40, 430], [60, 40, 430]]; // x, y, w&h-px
let textPosM = [[1.5, 54, 300] , [2.5, 54, 300] , [10, 54, 300], [4.5, 54, 300]]; // x, y, w&h-px
